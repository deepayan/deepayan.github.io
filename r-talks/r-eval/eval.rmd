...
<html>
  <head>
    <meta charset="utf-8">
    <title>Expressions, Evaluation and Scoping in R</title>
    <link rel="stylesheet" href="https://deepayan.github.io/assets/styles/remark.css">
  </head>
  <body>
    <textarea id="source">
...
* Useful links:
	...
	* [Source](https://github.com/deepayan/deepayan.github.io/blob/master/r-talks/r-eval/eval.rmd) of this talk (R + Markdown, similar to Rnw)
	
	* [Makefile](https://github.com/deepayan/deepayan.github.io/blob/master/r-talks/Makefile) containing conversion rules (using [knitr](https://cran.r-project.org/package=knitr) and [pandoc](https://pandoc.org/))
...
* What does `.Primitive()` do?
	...
	* Check `help(.Primitive)` (but we don't really need to understand details)
...
* However, these details often explain and diagnose many seemingly paranormal behaviour in R
...
* Given positive-valued data (say stock returns), one may be interested in "transforming" it to look normal
...
## Alternative: Minimize AIC

* A simpler alternative: use a popular model selection criterion such as AIC
...
* Similar approach: make function of $k$ from input data
